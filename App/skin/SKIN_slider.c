...
static int SKIN_slider(const WIDGET_ITEM_DRAW_INFO * pDrawItemInfo, unsigned char C)
{
	...
	case WIDGET_ITEM_DRAW_TICKS:
		break;
	default: return SLIDER_DrawSkinFlex(pDrawItemInfo);//emWin默认控件绘制函数
